package com.relinns.viegram.video;
...
import com.relinns.viegram.util.Config;
...
public class MediaController {
    ...
    private static MediaCodecInfo selectCodec(String mimeType) {
        ...
        for (int i = 0; i < numCodecs; i++) {
            ...
            for (String type : types) {
                if (type.equalsIgnoreCase(MediaController.MIME_TYPE)) {
    ...
    @TargetApi(16)
    public boolean convertVideo( String path) {
    //    path="/storage/emulated/0/DCIM/Camera/20171204_150828.mp4";
        Log.d("PAth", path);
        ...
        int resultWidth = (originalWidth*3)/4;
        int resultHeight = (originalHeight*3)/4;

        Log.d("MediaController", "result width : " + resultWidth + "  result height : " + resultHeight);
        Log.d("MediaController", "video width : " + originalWidth + "  video height : " + originalHeight + "  video rotation : " + rotationValue);
        int bitrate = 450000;
        int rotateRender = 0;
        ...
        File cacheFile = new File(cacheDir, "VIDEO_" + new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.US).format(new Date()) + ".mp4"
        );
        ...
        if (Build.VERSION.SDK_INT < 18 && resultHeight > resultWidth && resultWidth != originalWidth && resultHeight != originalHeight) {
            ...
            rotationValue = 90;
            rotateRender = 270;
            Log.d("MediaController", "when sdk<18 height : " + resultHeight + "  width : " + resultWidth);
            ...
            if (rotationValue == 90) {
                ...
                rotationValue = 0;
                rotateRender = 270;
                Log.d("MediaController", "when sdk>20 and rotation 90 height : " + resultHeight + "  width : " + resultWidth);
                ...
                rotationValue = 0;
                rotateRender = 90;
                Log.d("MediaController", "when sdk>20 and rotation 270 height : " + resultHeight + "  width : " + resultWidth);
            }
        }
        ...
        if (resultWidth != 0 && resultHeight != 0) {
            ...
            try {
                ...
                Log.d("MediaController", "movie size width  :" + movie.getWidth() + "  height : " + movie.getHeight());
                ...
                if (resultWidth != originalWidth || resultHeight != originalHeight) {
                    ...
                    if (videoIndex >= 0) {
                        ...
                        try {
                            ...
                            Log.d("Tag", "resultHeightAligned :" + resultHeightAligned);
                            Log.d("MediaController", "buffer size : " + bufferSize);
                            if (processorType == PROCESSOR_TYPE_OTHER) {
                                if (resultHeight % 16 != 0) {
                                    resultHeightAligned += (16 - (resultHeight % 16));
                                    padding = resultWidth * (resultHeightAligned - resultHeight);
                                    bufferSize += padding * 5 / 4;
                                    Log.d("MediaController", "provessor type other , result height aligned : " + resultHeightAligned + " buffer size : " + bufferSize);
                                }
                                ...
                                if (!manufacturer.toLowerCase().equals("lge")) {
                                    ...
                                    bufferSize += padding;
                                    Log.d("MediaController", "PROCESSOR_TYPE_QCOM , uvoffset: " + uvoffset + " buffer size : " + bufferSize);
                                }
                                ...
                                if (manufacturer.equals("baidu")) {
                                    ...
                                    padding = resultWidth * (resultHeightAligned - resultHeight);
                                    bufferSize += padding * 5 / 4;
                                    Log.d("MediaController", "PROCESSOR_TYPE_MTK , resultHeightAligned: " + resultHeightAligned + " buffer size : " + bufferSize);
                                }
                            }
                            ...
                            Log.d("MediaController", "result width : " + resultWidth + " height : " + resultHeight);
                            MediaFormat outputFormat = MediaFormat.createVideoFormat(MIME_TYPE, resultWidth, resultHeight);
//                            MediaFormat outputFormat = MediaFormat.createVideoFormat(MIME_TYPE, resultHeight, resultWidth);
                            ...
                            if (Build.VERSION.SDK_INT < 18) {
                                ...
                                Log.d("MediaController", "sdk<19   resultwidth : " + resultWidth + 32 + "  height : " + resultHeight);
                            }
                            ...
                            if (Build.VERSION.SDK_INT >= 18) {
                                ...
                                Log.d("MediaController", "decoder output sdk<18 width : " + resultWidth + " height : " + resultHeight + "  rotate : " + rotateRender);
                                                ...
                                                if (!errorWait) {
                                                    if (Build.VERSION.SDK_INT >= 18) {
                                                        ...
                                                        if (inputBufIndex >= 0) {
                                                            ...
                                                            Log.d("MediaController", "convert video frame : width : " + resultWidth + "  height : " + resultHeight);
