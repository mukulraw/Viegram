...
public class Config {
     ...
     */
    public static final String VIDEO_COMPRESSOR_APPLICATION_DIR_NAME = "Viegram/Media";

    /**
     * Application folder for video files
     */
    public static final String VIDEO_COMPRESSOR_COMPRESSED_VIDEOS_DIR = "/ViegramVideos/";
